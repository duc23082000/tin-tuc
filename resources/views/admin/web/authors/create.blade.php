    ...
    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" id="text-input" name="username" value="{{ old('username') }}" placeholder="User name..." class="form-control">
                @error('username')
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" id="text-input" name="email" value="{{ old('email') }}" placeholder="Email..." class="form-control">
                @error('email')
                    <small style="color: red">{{ $message }}</small>
                @enderror
            </div>     
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                ...
                <a href="{{ route('admin.author.lists') }}" class="btn btn-danger  btn-sm">
