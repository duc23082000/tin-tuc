...
<div class="col-md-12">
    ...
    <div class="table-data__tool-right">
        <a href="{{ route('admin.author.create') }}" class="au-btn au-btn-icon au-btn--green au-btn--small">
                ...
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%">
                            <form action="" method="get" >
                                <input type="hidden" name="search" value="{{ $search }}">
                                <input type="hidden" name="collum" value="username">
                                <input type="hidden" name="sort" value="{{ $sort }}">                           
                        ...
                        <th>
                            <form action="" method="get" >
                                <input type="hidden" name="search" value="{{ $search }}">
                                <input type="hidden" name="collum" value="email">
                                <input type="hidden" name="sort" value="{{ $sort }}">                           
                                <span>email <button><i class="fa fa-sort" aria-hidden="true"></i></button></span>
                            </form>
                        </th>
                        <th>Status</th>
                        <th style="width: 10%">
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td>
                            <div class="table-data-feature">
                                <a class="item" href="{{ route('admin.author.edit', [$item->id]) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                    <i class="zmdi zmdi-edit"></i>
                                </a>
                                <a class="item" href="{{ route('admin.author.delete', [$item->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
