                    ...
                    <tr class="tr-shadow">
                        ...
                        <td>
                            <div class="table-data-feature">
                                <a class="item" href="{{ route('admin.tag.edit', [$item->id]) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                    <i class="zmdi zmdi-edit"></i>
                                </a>
                                <a class="item" href="{{ route('admin.tag.delete', [$item->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
