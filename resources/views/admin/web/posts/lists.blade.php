...
<div class="col-md-12">
    ...
    <div class="table-data__tool-right">
        <a href="{{ route('admin.post.create') }}" class="au-btn au-btn-icon au-btn--green au-btn--small">
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td>
                            <div class="table-data-feature">
                                <a class="item" href="{{ route('admin.post.edit', [$item->id]) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                    <i class="zmdi zmdi-edit"></i>
                                </a>
                                <a class="item" href="{{ route('admin.post.delete', [$item->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
